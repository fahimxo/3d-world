...
export const Button = ({
  ...
  const buttonStyles =
    'relative w-full tracking-widest text-[12px] md:text-sm transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer h-[44px] px-7 flex items-center justify-center font-[700] transition';
