  ...
  return (
    <div className=" text-white w-full ">
      <div
        ...
        className={`flex flex-col md:flex-row justify-between items-start md:items-center p-4 md:px-8 cursor-pointer ${
          isOpen ? 'bg-[rgba(0,119,86,0.7)]' : 'bg-[rgba(0,119,86,0.25)]'
        } transition md:h-[81px] `}
      ...
      >
        <div className="flex items-center justify-between w-full md:w-auto">
          <div className="flex items-center gap-4 md:min-w-[200px]">
            ...
            <div className="text-[16px] truncate">{originalClubName}</div>
          </div>
        ...
        <div className="flex items-center gap-3 w-full justify-between px-0 md:px-5 mt-4 md:mt-0">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-[12px] font-[500] truncate">{city}</span>
          </div>
        </div>

        <div className="hidden md:flex flex-col items-center gap-3 justify-center">
          <button className="cursor-pointer " onClick={editClub}>
            <svg
              width="14"
              height="14"
