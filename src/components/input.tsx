        ...
        <div className="relative p-[2px] w-full" style={futuristicClipPath}>
          ...
          >
            ...
            <input
              ...
              id={name}
              className={cn(
                "flex h-12 w-full bg-transparent border-1 border-primary-200 px-3 py-2 text-base  text-cyan-200 file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-cyan-400/50 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
                Icon ? "pl-10" : "",
                className
              )}
              ref={ref}
